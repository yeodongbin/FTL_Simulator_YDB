...
public class Config {
	...
	/*
	 * // Logical Area static final int LOGICAL_BLOCK_NUM = 64; // plane size =
	 * 4096 static final int LOGICAL_PAGE_NUM = 4; // The number of pages in a
	 * block static final int TOTAL_LOGICAL_PAGE_NUM = LOGICAL_BLOCK_NUM *
	 * LOGICAL_PAGE_NUM;
	 * 
	 * // Overflow provision static final int OP_BLOCK_NUM = (FTL == 1) ? 32 :
	 * (((FTL == 2)||(FTL == 4)) ? 16 : (((FTL == 3)||(FTL == 5)) ? 16 : 0));
	 * static final int OP_PAGE_NUM = LOGICAL_PAGE_NUM; static final int
	 * TOTAL_OP_PAGE_NUM = OP_BLOCK_NUM * OP_PAGE_NUM;
	 * 
	 * // *Log Buffer Area // page static final int LOG_BLOCK_NUM = (FTL == 1) ?
	 * 0 : (((FTL == 2)||(FTL == 4)) ? 16 : (((FTL == 3)||(FTL == 5)) ? 12 :
	 * 0)); static final int LOG_PAGE_NUM = LOGICAL_PAGE_NUM; static final int
	 * TOTAL_LOG_PAGE_NUM = LOG_BLOCK_NUM * LOG_PAGE_NUM;
	 * 
	 * // **LogLog Buffer Area static final int LLOG_BLOCK_NUM = (FTL == 1) ? 0
	 * : (((FTL == 2)||(FTL == 4)) ? 0 : (((FTL == 3)||(FTL == 5)) ? 4 : 0));
	 * static final int LLOG_PAGE_NUM = LOGICAL_PAGE_NUM; static final int
	 * TOTAL_LLOG_PAGE_NUM = LLOG_BLOCK_NUM * LLOG_PAGE_NUM;
	 */
	...
	static final int TOTAL_LOGICAL_PAGE_NUM = LOGICAL_BLOCK_NUM
			* LOGICAL_PAGE_NUM;
...
/*
	...
	// Aging File
	static final String AGING_BLOCK_TABLE_INPUT = "./aging_Physical_Block"
			+ FTL + ".txt";
	static final String AGING_PAGE_TABLE_INPUT = "./aging_Physical_Page" + FTL
			+ ".txt";
	static final String AGING_RAM_INPUT = "./aging_LPN_PPN_Mapping_Table" + FTL
			+ ".txt";

	// Test용
	static final String BLOCK_TABLE_OUTPUT = "./Physical_Block" + FTL + ".txt";
	static final String PAGE_TABLE_OUTPUT = "./Physical_Page" + FTL + ".txt";
	static final String RAM_OUTPUT = "./LPN_PPN_Mapping_Table" + FTL + ".txt";
